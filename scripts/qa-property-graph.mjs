...
class McpSession {
  ...
  async initialize() {
    ...
    assertEqual(response.result.serverInfo?.version, runtimeVersion, "MCP server version")
...
const runtimeVersion = JSON.parse(readFileSync(join(root, "config", "runtime.json"), "utf8")).version
