...
final class CliHelp {
    ...
    private static final String COMPONENTS_HELP_TEXT = String.join(System.lineSeparator(),
            ...
            "Ordinary property fields are property, type, and applicable default, value_shape, row_type, row_properties, value_template, and value_options.",
            "For value_options, select by label and submit its paired native value; absence makes no finite-domain completeness claim.",
            "Property addresses are non-empty scalar arrays of strings and non-negative integer indexes.",
            "Example: property: [\"HTTPSampler.path\"]",
