const WRAPPER_HELP = [
  ...
  "  j4a install --only-skills",
  "  j4a install --force --only-skills",
  "  j4a mcp",
  "  j4a runtime-info --json",
  ...
  "  install --only-skills",
  "                     Copy j4a-master without reading, downloading, or running the runtime.",
  "  mcp                Starts the Java MCP server over stdio.",
  "                     If the runtime is missing, install it without --force before launch.",
  "  runtime-info --json",
  "                     Print wrapper, runtime, download, and cache metadata without network access.",
  "",
  "Notes:",
...
const INSTALL_HELP = [
  "j4a install downloads the configured runtime jar.",
  "",
  "Usage:",
  "  j4a install",
  "  j4a install --force",
  ...
  "  --only-skills      Copy j4a-master without accessing the runtime jar or network.",
  "                     Cannot be combined with --with-skills.",
